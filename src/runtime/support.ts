...
export type RigSideEffectLevel = "read" | "write" | "network" | "shell" | "destructive";
export type RigSideEffectDeclaration = RigSideEffectLevel | RigSideEffectLevel[];
...
> = {
  ...
  input: Input;
  output: Output;
  sideEffects: RigSideEffectDeclaration;
