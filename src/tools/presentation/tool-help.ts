...
export class ToolHelpRendererClass {
...
export class ToolHelpServiceClass {
  private readonly loader: ToolLoaderClass;
  private readonly renderer: ToolHelpRendererClass;

  constructor(options: ConfigOptions = {}) {
    this.loader = new ToolLoaderClass(options);
    this.renderer = new ToolHelpRendererClass();
  }
